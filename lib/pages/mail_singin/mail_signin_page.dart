...
class MailSigninPage extends ConsumerWidget {
        ...
        child: SingleChildScrollView(
          ...
          child: new Column(
            ...
            children: <Widget>[
              ...
              TextFormField(
                controller:
                    context.read(mailSigninController).emailInputController,
              ...
              TextFormField(
                controller:
                    context.read(mailSigninController).passwordInputController,
                decoration: const InputDecoration(
                  border: const UnderlineInputBorder(),
